window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function shouldRenderRailSurface(enabled, favoritesOnly, locatedCount, hasMore) {
			return enabled === true && (favoritesOnly === true || Number.isFinite(locatedCount) && locatedCount > 0 || hasMore === true);
		}
		...
		*/
		...
		function AdditiveTurnNavigation({ sessionId, useSession, usePreferences, loadOlder, forkAt, setPreference, t }) {
			...
			(0, react.useLayoutEffect)(() => {
				...
				if (column === null || list === null || root === null) {
