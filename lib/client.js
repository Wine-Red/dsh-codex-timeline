		...
		*/
		...
		function TurnNavigation({ useSession, usePreferences, layout, hasMore, loadingOlder, scrollToAnchor, trackAnchors, loadOlder, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				style: { "--turn-nav-height": `${layout.viewportHeight}px` },
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
		...
		const css = "._7-Z00G_group{gap:8px;display:grid}._7-Z00G_title{color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-strong-14)}._7-Z00G_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);line-height:18px}._7-Z00G_controls{gap:6px;margin-top:4px;display:grid}._7-Z00G_switch,._7-Z00G_densityRow{min-height:34px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-14);text-align:left;background:0 0;border:0;justify-content:space-between;align-items:center;gap:16px;padding:0;display:flex}._7-Z00G_switch{cursor:pointer}._7-Z00G_switchTrack{background:var(--dsw-alias-interactive-bg-hover-solid);border-radius:10px;flex:none;width:32px;height:18px;position:relative}._7-Z00G_switchTrack span{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:14px;height:14px;transition:transform .12s,background .12s;position:absolute;top:2px;left:2px}._7-Z00G_switchOn ._7-Z00G_switchTrack{background:var(--dsw-alias-brand-primary)}._7-Z00G_switchOn ._7-Z00G_switchTrack span{background:var(--dsw-alias-bg-overlay);transform:translate(14px)}._7-Z00G_segmented{background:var(--dsw-alias-interactive-bg-hover-solid);border-radius:8px;padding:2px;display:flex}._7-Z00G_segmented button{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;padding:4px 8px}._7-Z00G_segmented ._7-Z00G_selected{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-overlay);box-shadow:var(--dsw-shadow-lv1)}._7-Z00G_switch:focus-visible,._7-Z00G_segmented button:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}@media (prefers-reduced-motion:reduce){._7-Z00G_switchTrack span{transition:none}}";
		...
		var SettingsRow_module_css_default = {
			...
			"controls": "_7-Z00G_controls",
			"densityRow": "_7-Z00G_densityRow",
			"description": "_7-Z00G_description",
			"selected": "_7-Z00G_selected",
			"segmented": "_7-Z00G_segmented",
			"group": "_7-Z00G_group",
		...
		function TurnNavigationSettingsRow({ usePreferences, setPreference, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: SettingsRow_module_css_default.group,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: SettingsRow_module_css_default.controls,
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Switch, {
								label: t("settings.defaultVisible"),
								checked: settings.defaultVisible,
								onChange: (value) => {
									setPreference("defaultVisible", value);
								}
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Switch, {
								label: t("settings.followHighlight"),
								checked: settings.followHighlight,
								onChange: (value) => {
									setPreference("followHighlight", value);
								}
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: SettingsRow_module_css_default.densityRow,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("settings.density") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: SettingsRow_module_css_default.segmented,
									children: ["all", "sparse"].map((density) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										"aria-pressed": settings.density === density,
										className: settings.density === density ? SettingsRow_module_css_default.selected : void 0,
										onClick: () => {
											setDensity(density);
										},
										children: t(`settings.density.${density}`)
									}, density))
								})]
							})
						]
		...
		Schema.object({
			enabled: Schema.boolean().default(DEFAULT_TURN_NAVIGATION_SETTINGS.enabled),
			defaultVisible: Schema.boolean().default(DEFAULT_TURN_NAVIGATION_SETTINGS.defaultVisible),
			density: Schema.union([...TURN_NAVIGATION_DENSITIES]).default(DEFAULT_TURN_NAVIGATION_SETTINGS.density),
			followHighlight: Schema.boolean().default(DEFAULT_TURN_NAVIGATION_SETTINGS.followHighlight)
		});
		//#endregion
		...
		var TurnNavigationPreferences = class {
			...
			adopt() {
				...
				if (value.enabled === this.snapshot.enabled && value.defaultVisible === this.snapshot.defaultVisible && value.density === this.snapshot.density && value.followHighlight === this.snapshot.followHighlight) return;
		...
		function apply$1(ctx) {
			...
			const preferences = new TurnNavigationPreferences(ctx.settingsScope.bind({ namespace: TURN_NAVIGATION_SETTINGS_NAMESPACE }));
			ctx.effect(() => () => {
				preferences.dispose();
